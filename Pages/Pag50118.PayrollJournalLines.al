/*page 50118 PayrollJournalLines
{
    ApplicationArea = All;
    Caption = 'PayrollJournalLines';
    PageType = List;
    ...
    layout
    {
        area(content)
        {
            repeater(General)
            {
                ...
                {
                    ApplicationArea = All;
                    ToolTip = 'Specifies the value of the Allocated Amt. (LCY) field.';
                }
                ...
                {
                    ApplicationArea = All;
                    ToolTip = 'Specifies the value of the Bal. Gen. Bus. Posting Group field.';
                }
                field("Bal. Gen. Posting Type"; Rec."Bal. Gen. Posting Type")
                {
                    ApplicationArea = All;
                    ToolTip = 'Specifies the value of the Bal. Gen. Posting Type field.';
                }
                ...
                {
                    ApplicationArea = All;
                    ToolTip = 'Specifies the value of the Has Payment Export Error field.';
                }
                ...
                {
                    ApplicationArea = All;
                    ToolTip = 'Specifies the value of the Reverse Date Calculation field.';
                }
